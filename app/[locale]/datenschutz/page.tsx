  ...
  return (
    <section className="bubble-card space-y-6">
      ...
      <Section number={3} title="Allgemeine Hinweise und Pflichtinformationen">
        ...
        <Sub title="Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website">
          <P>
        ...
        <Sub title="Empfänger von personenbezogenen Daten">
          <P>
      ...
      <Section number={5} title="Plugins und Tools">
        <Sub title="OpenStreetMap">
          ...
          <P>
            ...
            Nutzung der OpenStreetMap-Karten wird eine Verbindung zu den
            Servern der OpenStreetMap-Foundation hergestellt. Dabei können u. a.
